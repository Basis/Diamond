...
from mongodb import MongoDBCollectionStatsCollector
...
class TestMongoDBCollectionStatsCollector(CollectorTestCase):
    def setUp(self):
        config = get_collector_config('MongoDBCollectionStatsCollector', {
            'host': 'localhost:27017',
            'databases': '^db',
        })
        self.collector = MongoDBCollectionStatsCollector(config, None)
        self.connection = MagicMock()

    def test_import(self):
        self.assertTrue(MongoDBCollectionStatsCollector)
